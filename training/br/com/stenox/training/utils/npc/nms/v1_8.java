...
public class v1_8 extends NPC
{
    ...
    public static PacketContainer buildSpawnBatPacket(final int entityId, final Location loc) {
        ...
        packet.getIntegers().write(2, floor(loc.getX() * 32.0));
        packet.getIntegers().write(3, floor(loc.getY() * 32.0));
        packet.getIntegers().write(4, floor(loc.getZ() * 32.0));

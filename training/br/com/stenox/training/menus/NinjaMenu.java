...
public class NinjaMenu extends Menu
{
    ...
    public void handleMenu(final InventoryClickEvent event) {
        ...
        final NinjaWarp warp = (NinjaWarp)Main.getInstance().getWarpController().search("Ninja");

...
public class SunshineAnimation {
    ...
    public SunshineAnimation(String text, String c1, String c2, String c3) {
        this(text, c1, c2, c3, 12);
    }

    public SunshineAnimation(String text, String c1, String c2, String c3, int p) {
        this.string = text;

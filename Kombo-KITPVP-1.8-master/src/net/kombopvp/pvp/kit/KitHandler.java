...
import net.kombopvp.pvp.cooldown1.WaveCooldown2;
...
protected void addCooldown(Player player, String cooldownName, long time) {
    ...
    WaveCooldown2.addCooldown(player, new net.kombopvp.pvp.cooldown1.WaveCooldownAPI(cooldownName, time));
}
...
protected void addCooldown(Player player, long time) {
    ...
    WaveCooldown2.addCooldown(player, new  net.kombopvp.pvp.cooldown1.WaveCooldownAPI(KitManager.getPlayer(player.getName()).getKit().getName(), time));
}
...
protected void addItemCooldown(Player player, ItemStack item, String cooldownName, long time) {
    ...
    WaveCooldown2.addCooldown(player, new  net.kombopvp.pvp.cooldown1.ItemCooldown(item, cooldownName, time));
}
}
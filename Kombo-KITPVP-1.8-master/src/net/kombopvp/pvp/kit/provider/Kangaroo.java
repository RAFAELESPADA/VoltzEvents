...
public class Kangaroo extends KitHandler {
	...
	public void execute(Player player) {
		...
		else if (p.getLocation().getY() > KomboPvP2.getInstance().getConfig().getInt("SpawnAltura") && EnderMageReal.isSpawn(p.getLocation()) && !WaveWarp2.LOBBY.hasPlayer(event.getPlayer().getName())) {
		...
		/* 150 */         org.bukkit.Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(KomboPvP2.getInstance(), new Runnable()
		/*     */         {
		/*     */           public void run()
		/*     */           {

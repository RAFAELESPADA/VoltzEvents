	 ...
	 @EventHandler(priority = EventPriority.HIGHEST)
	    ...
	    @EventHandler
		  public void onMove2ght(EntityDamageEvent e) {
	    	if (e.getEntity().getLocation().getY() > KomboPvP2.getInstance().getConfig().getInt("SpawnAltura") && EnderMageReal.isSpawn(e.getEntity().getLocation()) && !GladiatorListener2.combateGlad.containsKey(e.getEntity()) && !net.kombopvp.kit2.GladiatorListener.combateGlad.containsKey(e.getEntity())) {
	...
	return;
		    ...
		    Player p = (Player)e.getEntity();
			    ...
			    if (WaveWarp2.DUELS.hasPlayer(e.getEntity().getName())) {
			    	...
			    	if (p.getLocation().getY() > KomboPvP2.getInstance().getConfig().getInt("SpawnAltura") && EnderMageReal.isSpawn(e.getEntity().getLocation()) && !GladiatorListener2.combateGlad.containsKey(e.getEntity()) && !net.kombopvp.kit2.GladiatorListener.combateGlad.containsKey(e.getEntity())) {
			    	e.setCancelled(true);
			    	}
			    }
			...
			if (e.getEntity() instanceof Player && e.getDamager() instanceof Arrow) {
				...
				if (arrow.getShooter() != null && arrow.getShooter() instanceof Player) {
					...
					if (damagedPlayer.getName() != shooter.getName()) {
						...
						.runTaskLater(KomboPvP2.getInstance(), 2L);

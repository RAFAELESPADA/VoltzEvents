...
public class Buraco extends Warp
{
 ...
 public Buraco() {
     this.setName("Buraco");
     this.setPvp(true);
     this.setSpawn(new Location((World)Bukkit.getWorlds().get(0), Main.getInstance().getConfig().getInt("BuracoX"), Main.getInstance().getConfig().getInt("BuracoY"), Main.getInstance().getConfig().getInt("BuracoZ")));
 }

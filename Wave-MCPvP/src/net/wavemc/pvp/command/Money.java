...
public class Money implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        WavePlayer playerData = WaveBukkit.getInstance().getPlayerManager().getPlayer(sender.getName());
        ...
        if (command.getName().equalsIgnoreCase("money") || command.getName().equalsIgnoreCase("dinheiro")) {
            ...
            if (target == null) {
                ...
                WavePlayer targetData1 = WaveBukkit.getInstance().getPlayerManager().getPlayer(args[1]);
            ...
            WavePlayer targetData1 = WaveBukkit.getInstance().getPlayerManager().getPlayer(target.getName());
            if (targetData1 == null) return true;
